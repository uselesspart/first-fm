...
urlpatterns = [
    ...
    path('add-albums-collection/', views.add_albums_collection, name='add_albums_collection'),
    path('add-song-to-playlist/', views.add_song_to_playlist, name='add_song_to_playlist'),
    path('add-album-to-collection/', views.add_album_to_collection, name='add_album_to_collection'),
